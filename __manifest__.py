...
* **Zero-Trust Security**: Human-in-the-loop consent queue, strict resource allowlist, and per-user audit logging.
    ...
    'data': [
        ...
        'views/ai_ce_documentation_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'odoo_ai_ce/static/src/scss/ai_documentation.scss',
            ...
            'odoo_ai_ce/static/src/js/documentation/ai_documentation.js',
            'odoo_ai_ce/static/src/js/documentation/ai_documentation.xml',
        ],
    },
    'application': True,
    'installable': True,
